  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between w-full lg:pt-12 ">
            <div className="flex items-center space-x-16 flex-shrink-0">
              <a href="#">
                <h3
                  ...
                  } text-3xl lg:texl-4xl font-roboto font-extrabold leading-tight `}
                >
                  mabi
                </h3>
              </a>
              <div className="hidden lg:block pt-2">
                <div className=" flex items-baseline space-x-9">
                  <a
                    ...
                    className={`${
                      isScrolled
                        ? "text-[#475569] hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-[#475569]"
                        : "text-white  hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-white"
                    } text-base font-roboto font-medium leading-relaxed `}
                  >
                    Home
                  </a>
                  <a
            ...
            <div className="hidden lg:block">
              <div className="flex items-baseline space-x-6 ">
                <div
                  className={`${
                    isScrolled ? "border-[#475569]" : "border-white"
                  } rounded-full border-2 border-white py-[8px] px-[12px] cursor-pointer`}
                >
                  <h3
                    className={`${
                      isScrolled ? "text-[#475569]" : "text-white"
                ...
                <div
                  ...
                  } rounded-full border-2   py-[8px] px-[12px] cursor-pointer`}
                >
                  <h3
                    className={`${
      ...
      >
        ...
        <div>
          <a href="#">
            <h3 className="text-[#475569] text-3xl lg:texl-4xl font-roboto font-extrabold leading-tight text-center">
              mabi
            </h3>
          </a>
        </div>
        ...
        <div className="flex flex-col items-baseline p-4 space-y-7">
          <div className="border-[#475569] rounded-full border-2  py-[8px] px-[12px] cursor-pointer">
            <h3 className="text-[#475569]font-roboto text-base font-medium leading-relaxed">
              Log In
            </h3>
          </div>
          <div className="border-[#475569] bg-[#475569] rounded-full border-2   py-[8px] px-[12px] cursor-pointer">
            <h3 className="text-white font-roboto text-base font-medium leading-relaxed">
              Free Launch
            </h3>
          </div>
        </div>
